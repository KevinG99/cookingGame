...
/**
 * A convenient type alias for Saga<IngredientEvent?, GameCommand>
 */
typealias GameSaga = Saga<IngredientEvent?, GameCommand>
 ...
 *
 * `react` is a pure function/lambda that takes any event/action-result of type [IngredientEvent] as parameter, and returns the flow of commands/actions Flow<[GameCommand]> to be published further downstream.
 */
fun gameSaga() = GameSaga(
    react = { e ->
        when (e) {
